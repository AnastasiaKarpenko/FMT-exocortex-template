...
Рабочая директория: `/Users/anastasia/IWE/` (не из sub-директорий). `/Users/anastasia/IWE/memory/` = симлинк на auto-memory.
...
- `/Users/anastasia/IWE/` — рабочая директория
