...
```bash
python3 /Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/scripts/agent_fault_remind.py --protocol close
```
...
> ```bash
> python3 /Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/scripts/sync_feedback_to_memory.py
> ```
