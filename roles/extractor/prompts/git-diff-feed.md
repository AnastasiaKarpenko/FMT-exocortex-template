...
Читай:
1. `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/inbox/captures.md` — текущий inbox (для де-дупликации)
2. `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/inbox/feedback-log.md` — паттерны reject
...
for repo in /Users/anastasia/Documents/IWE/*/; do
  if [ -d "$repo/.git" ]; then
    name=$(basename "$repo")
