...
Читай:
1. `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/inbox/captures.md` — целевой файл (куда писать)
2. `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/inbox/feedback-log.md` — паттерны reject (не предлагай похожее)
...
```bash
cd /Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}
...
Лог попадёт в `/Users/anastasia/logs/extractor/{date}.log`. Пользователь не получает уведомление до следующего `/apply-captures`.
