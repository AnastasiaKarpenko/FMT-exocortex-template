...
LOG_DIR="/Users/anastasia.karpenko/logs/synchronizer"
STRATEGY_DIR="/Users/anastasia.karpenko/Github/DS-strategy"
...
STRATEGIST_LOG="/Users/anastasia.karpenko/logs/strategist/$DATE.log"
...
"
        if echo "$warnings" | grep -q "push failed" 2>/dev/null; then
            report+="- **push failed:** Mac был оффлайн. Запусти \`cd /Users/anastasia.karpenko/Github/DS-strategy && git pull --rebase && git push\`
"
        fi
    else
        report+="
