...
LOG_DIR="/Users/anastasia/logs/synchronizer"
STRATEGY_DIR="/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}"

# Agent Workspace: если существует — отчёты идут туда
AGENT_WORKSPACE="/Users/anastasia/Documents/IWE/DS-agent-workspace"
...
STRATEGIST_LOG="/Users/anastasia/logs/strategist/$DATE.log"
...
"
        if echo "$warnings" | grep -q "push failed" 2>/dev/null; then
            report+="- **push failed:** Mac был оффлайн. Запусти \`cd /Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}} && git pull --rebase && git push\`
"
        fi
    else
        report+="
