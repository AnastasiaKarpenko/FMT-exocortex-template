...
notify_telegram() {
    local scenario="$1"
    "/Users/anastasia.karpenko/Github/FMT-exocortex-template/roles/synchronizer/scripts/notify.sh" strategist "$scenario" >> "$LOG_FILE" 2>&1 || true
}
...
case "$1" in
    ...
    "week-review")
        ...
        KI_REPO="/Users/anastasia.karpenko/Github/DS-Knowledge-Index-morganaloca@gmail.com"
