...
- **WeekPlan:** /Users/anastasia.karpenko/Github/DS-strategy/current/WeekPlan W*.md
...
git -C /Users/anastasia.karpenko/Github/<repo> log --since="last monday 00:00" --until="today 00:00" --oneline --no-merges
```
...
> Проверь: существует ли директория `/Users/anastasia.karpenko/Github/DS-Knowledge-Index-morganaloca@gmail.com/`?
> Если нет — пропусти шаг 6 полностью.

1. Переключись на **роль Автора (R4)** и на основе WeekReport сформируй пост для клуба.

   **Обязательно прочитай** `/Users/anastasia.karpenko/Github/DS-Knowledge-Index-morganaloca@gmail.com/CLAUDE.md` — полные инструкции роли Автора:
...
2. Создай файл `/Users/anastasia.karpenko/Github/DS-Knowledge-Index-morganaloca@gmail.com/docs/{YYYY}/{YYYY-MM-DD}-week-review-w{N}.md`
...
4. Обнови `/Users/anastasia.karpenko/Github/DS-Knowledge-Index-morganaloca@gmail.com/docs/README.md` — добавь строку в начало текущего месяца
