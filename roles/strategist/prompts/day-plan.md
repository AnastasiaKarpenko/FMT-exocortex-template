...
2. **Итоги вчера** — `git log --since="yesterday 00:00" --until="today 00:00"` по ВСЕМ репо в `/Users/anastasia/Documents/IWE/`:
   - Группировка по репо
...
- ✅ Все решения принимай по skill /day-open (`${IWE_WORKSPACE:-/Users/anastasia/Documents/IWE}/.claude/skills/day-open/SKILL.md`)
...
- HUB: `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/current/`
- SPOKES: `/Users/anastasia/Documents/IWE/*/WORKPLAN.md`
- MEMORY: `~/.claude/projects/{{CLAUDE_PROJECT_SLUG}}/memory/`
- Skill: `/Users/anastasia/Documents/IWE/.claude/skills/day-open/SKILL.md`
- Templates: `~/.claude/projects/{{CLAUDE_PROJECT_SLUG}}/memory/templates-dayplan.md`
- Scaffold: `/Users/anastasia/Documents/IWE/scripts/day-open-scaffold.sh`
- Extensions: `/Users/anastasia/Documents/IWE/extensions/day-open.before.md`, `.after.md`, `.checks.md`
