...
Источник сценария: /Users/anastasia.karpenko/Github/CLAUDE.md → Протокол Day-Close

## Контекст

- **WeekPlan:** /Users/anastasia.karpenko/Github/DS-strategy/current/WeekPlan W*.md (последний по дате)
- **MEMORY:** ~/.claude/projects/-Users-anastasia.karpenko-Github/memory/MEMORY.md
- **Exocortex backup:** /Users/anastasia.karpenko/Github/DS-strategy/exocortex/
...
```bash
# Для КАЖДОГО репо в /Users/anastasia.karpenko/Github/:
git -C /Users/anastasia.karpenko/Github/<repo> log --since="today 00:00" --oneline --no-merges
```

- Пройди по ВСЕМ репозиториям в `/Users/anastasia.karpenko/Github/`
...
Скопируй актуальные файлы в `/Users/anastasia.karpenko/Github/DS-strategy/exocortex/`:

```bash
# Корневой CLAUDE.md
cp /Users/anastasia.karpenko/Github/CLAUDE.md /Users/anastasia.karpenko/Github/DS-strategy/exocortex/CLAUDE.md

# Memory (Слой 3)
cp ~/.claude/projects/-Users-anastasia.karpenko-Github/memory/MEMORY.md /Users/anastasia.karpenko/Github/DS-strategy/exocortex/MEMORY.md
cp ~/.claude/projects/-Users-anastasia.karpenko-Github/memory/*.md /Users/anastasia.karpenko/Github/DS-strategy/exocortex/
```
