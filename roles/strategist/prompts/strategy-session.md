...
- **HUB (личные планы):** /Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/current/
- **Документы стратегии:** /Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/docs/ (Strategy.md, Dissatisfactions.md, Session Agenda.md)
- **Inbox:** /Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/inbox/
- **SPOKE (планы репо):** /Users/anastasia/Documents/IWE/*/WORKPLAN.md
...
- Если да:
  1. Найди последний `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/archive/MonthClose YYYY-MM.md` (за прошлый месяц)
  2. Прочитай ОБЯЗАТЕЛЬНО ДО шага 1: мультипликатор, фаза, калибр, ревизия проектов, инсайты решений, R-вопросник, carry-over
  3. Прочитай `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/archive/multiplier-trend.md` (если есть) для динамики
...
- **Loop C input (WP-364 Ф2.2):** проверь `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/current/weekly-digest.md`. Если файл есть и `valid_until ≥ today` — прочитай его как **supplementary input от Аналитика**: коммиты недели, закрытые РП, кандидаты bottleneck'а. Стратег (пилот) не обязан следовать кандидатам — это сырьё для собственного решения. Если файла нет или просрочен — пропусти этот пункт, работай по черновику и истории.
...
1. **Прочитай трекер:** `/Users/anastasia/Documents/IWE/{{GOVERNANCE_REPO}}/docs/Caliber-artifacts-tracker.md` (если файла нет — создай из шаблона `/Users/anastasia/Documents/IWE/FMT-exocortex-template/templates/strategy-skeleton/docs/Caliber-artifacts-tracker.md`)
