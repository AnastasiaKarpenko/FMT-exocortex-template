...
3. **ТО памяти (T, SC.024.3)** — проверка здоровья статической нагрузки:
   - `wc -l /Users/anastasia/Documents/IWE/.claude/rules/distinctions.md` → **> 80 строк = drift-флаг** (по правилу DP.KR.001 §6: 1-3 строки на различение). Предложить аудит в WP-7.
