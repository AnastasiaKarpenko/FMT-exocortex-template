...
```bash
IWE_EXECUTOR_CATALOG=/Users/anastasia/Documents/IWE/DS-strategy/scripts/executor-catalog.yaml \
bash /Users/anastasia/Documents/IWE/scripts/route-task.sh --skill <skill-name>
```
